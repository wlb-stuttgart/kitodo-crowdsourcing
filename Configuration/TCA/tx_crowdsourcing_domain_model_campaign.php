...
$tca = [
    'ctrl' => [
        'title' => 'LLL:EXT:crowdsourcing/Resources/Private/Language/locallang_db.xlf:tx_crowdsourcing_domain_model_campaign',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'delete' => 'deleted',
        ...
        '1' => [
            'showitem' =>
                '--div--;LLL:EXT:core/Resources/Private/Language/Form/locallang_tabs.xlf:general,
                    title, subtitle, description, short_description, workflow_state, image,
    ...
    'palettes' => [
        'hidden' => [
            'showitem' => '
                hidden;LLL:EXT:crowdsourcing/Resources/Private/Language/locallang_db.xlf:tx_crowdsourcing_domain_model_campaign.hidden
            ',
        ],
        'access' => [
            'label' => 'LLL:EXT:crowdsourcing/Resources/Private/Language/locallang_db.xlf:tx_crowdsourcing_domain_model_campaign.palettes.access',
            'showitem' => '
    ...
    'columns' => [
        'hidden' => [
            'exclude' => true,
            'label' => 'LLL:EXT:crowdsourcing/Resources/Private/Language/locallang_db.xlf:tx_crowdsourcing_domain_model_campaign.hidden',
            'config' => [
                'type' => 'check',
        ...
        'l18n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' =>
                    'AND {#tx_crowdsourcing_domain_model_campaign}.{#pid}=###CURRENT_PID###
                     AND {#tx_crowdsourcing_domain_model_campaign}.{#sys_language_uid} IN (-1,0)',
                'default' => 0,
            ],
        ],
        'l10n_source' => [
        ...
        'title' => [
            'label' => 'LLL:EXT:crowdsourcing/Resources/Private/Language/locallang_db.xlf:tx_crowdsourcing_domain_model_campaign.title',
            'config' => [
                'type' => 'input',
                'size' => 40,
                'max' => 255,
        ...
        'fe_group' => [
            'exclude' => true,
            'l10n_mode' => 'exclude',
            'label' => 'LLL:EXT:crowdsourcing/Resources/Private/Language/locallang_db.xlf:tx_crowdsourcing_domain_model_campaign.fe_group',
            'config' => [
                'type' => 'select',
